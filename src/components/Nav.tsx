    ...
    return (
        <div className="w-full bg-white shadow-md py-4 px-6 flex justify-between items-center sticky top-0 z-20">
            ...
            <div className="items-center space-x-6 lg:flex xl:flex 2xl:flex hidden">
                <div className="text-gray-600 hover:text-gray-800 hover:cursor-pointer gap-2 flex flex-col items-center">
                    <img src="House.svg" alt="" className="h-[25px] w-[25px] hover:fill-gray-800" />
                    <p className="text-xs font-medium">Home</p>
                </div>
                <div className="text-gray-600 hover:text-gray-800 hover:cursor-pointer gap-2 flex flex-col items-center">
                    <img src="ChartPieSlice.svg" alt="" className="h-[25px] w-[26px] hover:fill-gray-800" />
                    <p className="text-xs font-medium">Dashboard</p>
                </div>

                <div className="text-gray-600 hover:text-gray-800 hover:cursor-pointer gap-2 flex flex-col items-center">
                    <img src="Wallet.svg" alt="" className="h-[25px] w-[26px] hover:fill-gray-800" />
                    <p className="text-xs font-medium">Wallet</p>
                </div>

                <div className="text-gray-600 hover:text-gray-800 hover:cursor-pointer gap-2 flex flex-col items-center">
                    <img src="ListChecks.svg" alt="" className="h-[25px] w-[26px] hover:fill-gray-800" />
                    <p className="text-xs font-medium">Plan a trip</p>
                </div>

                <div className="text-gray-600 hover:text-gray-800 hover:cursor-pointer gap-2 flex flex-col items-center">
                    <img src="HandCoins.svg" alt="" className="h-[25px] w-[26px] hover:fill-gray-800" />
                ...
                <div className="text-gray-600 hover:text-gray-800 hover:cursor-pointer gap-2 flex flex-col items-center">
                    <img src="Bell.svg" alt="" className="h-[25px] w-[26px] hover:fill-gray-800" />
                    <p className="text-xs font-medium">Notification</p>
                </div>

                <div className="text-gray-600 hover:text-gray-800 hover:cursor-pointer gap-2 flex flex-col items-center">
                    <img src="Basket.svg" alt="" className="h-[25px] w-[26px] hover:fill-gray-800" />
                    <p className="text-xs font-medium">Carts</p>
                </div>

                <div className="text-gray-600 hover:text-gray-800 hover:cursor-pointer gap-2 flex flex-col items-center">
                    <img src="PlusSquare.svg" alt="" className="h-[25px] w-[26px] hover:fill-gray-800" />
                ...
                <div className="text-gray-600 hover:text-gray-800 hover:cursor-pointer gap-2 flex items-center">
                    ...
                    <img src="CaretDown.svg" alt="" className="h-[25px] w-[26px] hover:fill-gray-800" />
                </div>
